...
struct Node *deleteNode(struct Node *root, char string[100])
{
	struct Node *temp, *preTemp;
	temp = root;
	...
	while(temp != NULL)
	{
		if(strcmp(temp->string, string) == 0)
		{
			...
			else
			{
				...
				strcpy(temp->string, temp2->string);
...
// struct Node *delNodeByName(struct Node *temp, struct Node *preTemp, char string[100])
// {
// 	if(temp != NULL)
// 	{
// 		if(strcmp(temp->string, string) == 0)
...
// 		else
// 		{
// 			delNodeByName(temp->left, temp, string);
// 			delNodeByName(temp->right, temp, string);
// 		}
// 	}
// 	return preTemp;
// }
